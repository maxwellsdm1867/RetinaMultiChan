...
for k = 2 : n_burst
close all
clearvars -except BinningSpike SepBurst directory file filename DirectorySub...
           t_line DataTime k BurstI BurstF BurstAna temp
    name = [filename(14:length(filename)-4)] ;
...
name = ['BurstAna_' filename(11:length(filename)-4) '.mat'];
